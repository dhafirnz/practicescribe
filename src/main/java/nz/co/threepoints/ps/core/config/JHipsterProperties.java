...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "PracticeScribe@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "PracticeScribe API";

        private String description = "PracticeScribe API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "PracticeScribe";
